...
import Banner1 from "../../assets/Images/header/banner1.png";
import Banner2 from "../../assets/Images/header/banner2.png";
...
export const FooterData = {
  logo: logo,
  addresses: ["Kabul, Afghanistan"],
  phone: "+93 785 0328 858",
  departments: [
    "Cardiology",
    "Dentistry",
    "Neurology",
